            ...
            <div className="relative z-10 flex gap-6 items-stretch">
                ...
                <div className="flex flex-col flex-1 min-w-0">
                    ...
                    <div className="mb-3 pt-1">
                        <span className="inline-block px-3 py-1 rounded-full text-xs font-medium mb-3 bg-gradient-to-r from-amber-500/20 to-orange-500/20 text-amber-400 border border-amber-500/30">
                            Project
                        </span>
                        <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-amber-100 bg-clip-text text-transparent">
                            {project.title}
                        </h3>
                    </div>
                    ...
                    {/* Links */}
                    <div className="flex items-center gap-5 pt-4 border-t border-amber-500/20">
                        {project.githubUrl && (
                            <a
                ...
                {/* Divider */}
                <div className="w-px bg-amber-500/20 self-stretch shrink-0 mt-8 mb-4" />

                {/* Right: Focus areas */}
                <div className="flex flex-col gap-2 justify-center w-36 shrink-0 pt-8">
                    {project.focusAreas.map((area, idx) => (
                        <span
                            key={idx}
                            className="text-xs px-3 py-1.5 rounded-lg bg-white/8 text-slate-300 border border-amber-500/20 hover:border-amber-500/40 transition-colors text-center"
                        >
                            {area}
                        </span>
                    ))}
